			...
			<article id="register-wrap" class="signin-wrap center">
				...
				<ul>
					<li>
						...
						<label for="ruser" class="signin-label">Minimum 3 letters or numbers</label>
					</li>
					<li>
						<input id="remail" type="email" name="remail" placeholder="Email Address" class="signin-box" />
						<span class="check-dot"></span>
						<label for="remail" class="signin-label">Use proper email format</label>
					</li>
					<li>
						<input id="rpass" type="password" name="rpass" placeholder="Password" class="signin-box" />
						<span class="check-dot"></span>
						<label for="rpass" class="signin-label">At least 8 characters</label>
					</li>
					<li>
						<input id="rpassconf" type="password" name="rpassconf" placeholder="Confirmation" class="signin-box" />
						<span class="check-dot"></span>
						<label for="rpassconf" class="signin-label">Must match password exactly</label>
					</li>
