...
<body class="reset">
	<div id="alerts" class="round-box"><div class="alert-but center pointer">OK</div></div>
	<div id="overlay"></div>
	<header>
	...
	<section class="container center" >
		<form action="process.php" method="post">
			<article id="login-wrap" class="signin-wrap round-box center">
				<h2 class="reset">Login</h2>
				<ul class="reset">
					<li>
						<input id="luser" type="text" name="luser" placeholder="Username" class="signin-box" />
						<span class="check-dot"></span>
					</li>
					<li>
						<input id="lpass" type="password" name="lpass" placeholder="Password" class="signin-box" />
						<span class="check-dot"></span>
					</li>
					<li>
						<input type="reset" value="Clear" class="reset signin-but pointer clear" /><input id="login" type="submit" class="reset signin-but pointer submit" value="Login" />
					</li>
					<li>
						<a href="#" class="block signin-toggle">Don't have an account?</a>
					</li>
				</ul>
			</article>
			<article id="register-wrap" class="signin-wrap round-box center">
				<h2 class="reset">Register</h2>
				<ul class="reset">
					<li>
					...
					<li>
						<input type="reset" value="Clear" class="reset signin-but pointer clear" /><input id="register" type="submit" class="reset signin-but pointer submit" value="Register" />
						<a href="#" class="block signin-toggle">Already have an account?</a>
					</li>
				</ul>
			</article>
